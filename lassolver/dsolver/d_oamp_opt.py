...
class D_OAMP_OPT(D_Base):
    def __init__(self, A, x, noise, P):
        ...
        self.oamps = [doamp_opt(self.A_p[p], x, self.noise[p], self.M) for p in range(self.P)]
    ...
    def _update_s(self, C, w, log):
        s, communication_cost, V, b, z = GCOAMP_opt(w, self.tau_p, log)
