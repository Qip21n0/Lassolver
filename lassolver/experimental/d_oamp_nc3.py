...
class D_OAMP_nc3(D_Base):
    def __init__(self, A, x, noise, P):
        ...
        self.oamps = [doamp_nc3(self.A_p[p], x, self.noise[p], self.M) for p in range(self.P)]
